      ...
      <div className="relative z-10 w-full max-w-xs poker-card p-8 flex flex-col items-center justify-center animate-fade-in shadow-2xl">
        ...
        <div className="w-full">
          <Button
            ...
            disabled={loading}
            className="w-full h-14 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium text-base gap-3 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
          >
            {loading ? (
